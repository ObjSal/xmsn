...
Private intTimeout As Integer 'if we get to 35 seconds we timeout on connect
...
Private Sub sckMain_Connect(Index As Integer)
    ...
    If Index = 0 Then
        ...
        strSend = "VER " & TRID & " MSNP7 MSNP6 MSNP5 MSNP4 CVR0" & Chr(13) & Chr(10)
...
Public Sub MSNConnect(Optional IPAddr As String = "64.4.13.222", Optional Port As Long = 1863)
...
NXT:
        ...
        Case Is = "MSG"
            ...
            arrTemp() = Split(strData, vbCrLf)
            If InStr(arrTemp(2), "x-msmsgsprofile") = 0 And InStr(arrTemp(2), "text/x-msmsgsinitialemailnotification") = 0 Then
...
Public Function MSNGetErrorDesc(ErrNumber As Long) As String
    ...
    Select Case ErrNumber
        ...
        Case Is = 99
            MSNGetErrorDesc = "Connection To Server Timed Out"
...
Private Sub tmrTimeout_Timer()
    ...
    If intTimeout = 35 Then
        
        Do
            sckMain(0).Close
        Loop Until sckMain(0).State = 0
        
        RaiseEvent MSNError(99)
